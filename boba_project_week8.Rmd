...
library(DescTools)
getwd()
nyc_boba<- read.csv("nyc_boba_shops-2.csv")
raleigh_boba<- read.csv("boba_manual.csv")
head(nyc_boba)
head(raleigh_boba)
...
write.csv(nyc_indicator, "/Users/violetevans/Documents/side project/nyc_boba1.csv", row.names = FALSE)
```


```{r}
final_nyc<- read.csv("/Users/violetevans/Documents/side project/nyc_boba1.csv")
...
write.csv(combined_data, "/Users/violetevans/Documents/side project/combined_data.csv", row.names = FALSE)
head(combined_data)
```

#Combined Data
```{r}
combined_data <- read.csv("/Users/violetevans/Documents/side project/combined_data.csv")
...
combined_data$Authenticity[combined_data$Name== "Tbaar"] <- 0
nyc_raleigh_final_comb <-combined_data
nyc_raleigh_final_comb$Authenticity <- unlist(nyc_raleigh_final_comb$Authenticity)
write.csv(nyc_raleigh_final_comb, "/Users/violetevans/Documents/side project/nyc_raleigh_final_comb.csv", row.names = FALSE)
```
